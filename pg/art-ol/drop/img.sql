...
ALTER TABLE IF EXISTS ONLY model_name_hash DROP CONSTRAINT IF EXISTS model_name_hash_pkey;
ALTER TABLE IF EXISTS ONLY model_name_hash DROP CONSTRAINT IF EXISTS model_name_hash_name_hash_key;
...
ALTER TABLE IF EXISTS model_name_hash ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS model_name_hash_id_seq;
DROP TABLE IF EXISTS model_name_hash;
