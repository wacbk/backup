...
ALTER TABLE IF EXISTS ONLY civitai_model_last_post DROP CONSTRAINT IF EXISTS civitai_model_last_review_pkey;
...
DROP TABLE IF EXISTS civitai_model_last_post;
